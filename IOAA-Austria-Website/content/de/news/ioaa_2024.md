...
<div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center; width: 70%; gap: 30px; margin: 0 auto; text-align: center;">
    <img src="/images/teleskop-austria_logo-PRESS.png" alt="Telescop-Austria" style="width: 35%;">
    <img src="/images/mmf logo.png" alt="Projekt MmF" style="width: 55%;">
    <img src="/images/Raiffeisenbank Region Feldbach.svg" alt="Raiffeisen Region Feldbach" style="width: 25%;">
    <img src="/images/BA 2D_4c_Pos_V_RGB.JPG" alt="UniCredit Bank Austria" style="width: 25%;">
    <img src="/images/logo.png" alt="Hagleitner" style="width: 25%;">
    <img src="/images/thumbnail_haller-logo.png" alt="hallermobil" style="width: 25%;">
</div>
